...
class GlossaryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SearchTerms = channel.unary_stream(
...
def add_GlossaryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SearchTerms': grpc.unary_stream_rpc_method_handler(
...
class GlossaryService(object):
    ...
    def ListTerms(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/glossary.GlossaryService/ListTerms',
    ...
    def SearchTerms(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/glossary.GlossaryService/SearchTerms',
